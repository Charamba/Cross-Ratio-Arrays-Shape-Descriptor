...
def thread_function_old(template_folder, template_descriptors, query_folder, result_folder):
    query_descriptors = os.listdir(query_folder)
...
if argc >= 4:
    ...
    print("Usage: ")
    print(" ")
    print(">> python test_script_compare_descriptors.py template_descriptors_directory query_descriptors_directory matching_results_directory")
