...
tomographic_scan_template = False
...
if convex_hull_scan_template:
	templateDescriptor_1 = templateScanner.hull_scan(convexHullVertices, fanBeamRays=template_nFanBeam, showTrajectories=showTrajectories, verticeIndexList=[])
...
if convex_hull_scan_test:
	testDescriptor_1 = testScanner.hull_scan(convexHullVertices, fanBeamRays=test_nFanBeam, showTrajectories=showTrajectories, verticeIndexList=[])
...
# print("templateDescriptor: ", templateDescriptor)
# print("testDescriptor: ", testDescriptor)
...
if compare:
	if compareByRays:
		...
		(matching_result, mTemplRays, mTestRays, bTemplRays, bTestRays, vanishPoints) = matchingProcessor.compareByPencils()
