...
def main_test(template_nFanBeam_input, test_nFanBeam_input, emitter_points_number_input):
    ...
    for t in tst_filename:
        ...
        file_name = 'resultados/elevation50/testes' + str(emitter_points_number_input) +'/' + str(test_nFanBeam) + test_name + '.txt'
        try:
        ...
        for x in tem_filename:
            ...
            if(len(ncurves_test) == len(ncurves_temp)): 
                ...
                file_name = 'resultados/elevation50/templates'+ str(emitter_points_number_input) +'/' + str(template_nFanBeam) + temp_name + '.txt'
                try:
                    with open(file_name, 'rb') as myFile:
                ...
                if compare:
                    if compareByRays:
                        ...
                        with open('resultados/elevation50/r' +' ' + str(emitter_points_number) + ' ' + str(test_nFanBeam) + '.txt' , 'a') as arq:
                            arq.write(result)
                        with open('resultados/elevation50/r' +' ' + str(emitter_points_number) + ' ' + str(test_nFanBeam) + '_pairs.txt' , 'a') as arq:
                            arq.write(r)
